...
import type { QuadConsensusResult } from '../services/aiVisionService';
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
            {/* Quad-Core AI Verification Ensemble Status Indicator */}
            <div
              style={{
              ...
              title="Quad-Core AI Ensemble: In-House AI + Gemini + Groq + ChatGPT working together concurrently"
            >
              <Bot size={16} color="var(--cyan-primary)" />
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <span style={{ fontWeight: 800, color: 'var(--cyan-primary)' }}>Quad-Core AI:</span>
                <span style={{ color: 'var(--text-secondary)' }}>All 4 Models Active</span>
              </div>
            </div>
